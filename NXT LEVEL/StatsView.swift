        ...
        VStack(alignment: .leading, spacing: 10) {
            HStack() {
                ...
                HStack(spacing: 20) {
                    ...
                    AdjustGoals(showGoalSheet: $showGoalSheet, iconOnly: true)
                }
                .font(.system(size: 18))
                .glassEffect()
            }
...
//                            icon: "figure.walk",
//                            subtitle: "Goal: \(healthKitManager.stepGoal)",
//                            progress: Double(Int(healthKitManager.stepCount.replacingOccurrences(of: ",", with: "")) ?? 0) / Double(healthKitManager.stepGoal),
